...
export default function TargetMotivationWidget({
  targets,
}: TargetMotivationWidgetProps) {
      ...
      <div className="relative flex items-center gap-4">
        ...
        <div className="relative flex-shrink-0">
          <svg
            ...
            role="img"
            aria-label={`Progress: ${Math.round((targets.filter((t) => t.completed).length / Math.max(targets.length, 1)) * 100)}%`}
          >
            <circle
              cx="44"
              cy="44"
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-white/90 text-xs font-medium leading-snug mb-2">
            {message}
          </p>

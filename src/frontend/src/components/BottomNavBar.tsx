...
import { Bell, BookOpen, HelpCircle, Home, Target } from "lucide-react";
        ...
        {NAV_ITEMS.map(({ to, label, icon: Icon, exact }) => {
          ...
          return (
            ...
            >
              ...
              <div
                className={`p-1.5 rounded-xl transition-all duration-200 ${active ? "bg-primary/10" : ""}`}
              >
                <Icon
              ...
              <span
                className={`text-[10px] font-medium leading-none ${active ? "font-bold" : ""}`}
              >
                {label}
              </span>
            </Link>

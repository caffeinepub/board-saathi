...
export default function RemindersPage() {
  ...
  const handleAdd = async () => {
    ...
    const dateTimeStr = reminderTime
    ...
    try {
      ...
      toast.success(
        "Reminder added! You'll get a notification 5 min before & alarm at the set time.",
      );
      setReminderText("");
      setReminderDate("");
      setReminderTime("");
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">
            {upcoming.length} upcoming reminder
            {upcoming.length !== 1 ? "s" : ""}
          </p>
        </div>
      ...
      <Dialog open={addOpen} onOpenChange={handleDialogClose}>
        <DialogContent className="max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription>
              Set a reminder with an alarm sound for an important study task or
              event.
            </DialogDescription>
          </DialogHeader>

...
function DaysLeftBanner() {
  ...
  return (
    <div
      className={`rounded-2xl bg-gradient-to-r ${urgencyColor} p-4 text-white shadow-md`}
    >
            ...
            <CardContent className="px-4 pb-4 space-y-2">
              {activeTargets.map((target) => {
                const daysUntil = Math.ceil(
                  (target.deadline - now) / (1000 * 60 * 60 * 24),
                );
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-0.5">
                        ...
                        {isUrgent && !isOverdue && (
                          <Badge className="text-[9px] h-4 px-1.5 bg-orange-500">
                            Due soon
                          </Badge>
                        )}
                      </div>

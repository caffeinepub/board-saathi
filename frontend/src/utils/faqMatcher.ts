...
const FAQ_DATABASE: FAQEntry[] = [
  {
    keywords: ['planner', 'calendar', 'schedule', 'task', 'daily', 'plan', 'study plan'],
    response:
  ...
  {
    keywords: ['subject', 'subjects', 'maths', 'english', 'science', 'sst', 'sanskrit', 'it', 'information technology'],
    response:
  ...
  {
    keywords: ['note', 'notes', 'camera', 'photo', 'image', 'capture', 'picture'],
    response:
  ...
  {
    keywords: ['question', 'questions', 'practice', 'add question', 'chapter question'],
    response:
  ...
  {
    keywords: ['mock test', 'test', 'mcq', 'create test', 'attempt test', 'exam'],
    response:
  ...
  {
    keywords: ['report', 'result', 'score', 'percentage', 'test result', 'test report'],
    response:
  ...
  {
    keywords: ['progress', 'tracker', 'progress tracker', 'performance', 'statistics', 'stats'],
    response:
  ...
  {
    keywords: ['login', 'logout', 'register', 'sign up', 'account', 'profile', 'username', 'password'],
    response:
  ...
  {
    keywords: ['profile', 'edit profile', 'name', 'school', 'class', 'update profile'],
    response:
  ...
  {
    keywords: ['help', 'how to', 'how do i', 'what is', 'explain', 'guide', 'tutorial'],
    response:

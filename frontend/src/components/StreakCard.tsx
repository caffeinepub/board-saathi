...
export default function StreakCard({ currentStreak, topStreak }: StreakCardProps) {
  const milestones = [
    { days: 3, icon: '🏅', label: '3-Day Streak', color: 'bg-amber-100 text-amber-700 dark:bg-amber-950/40 dark:text-amber-400' },
    { days: 7, icon: '🏆', label: '7-Day Streak', color: 'bg-orange-100 text-orange-700 dark:bg-orange-950/40 dark:text-orange-400' },
    { days: 30, icon: '👑', label: '30-Day Streak', color: 'bg-red-100 text-red-700 dark:bg-red-950/40 dark:text-red-400' },
  ];
    ...
    <Card className="overflow-hidden">
      <div className="bg-gradient-to-br from-orange-500 to-red-500 p-4 text-white">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-orange-100 text-xs font-medium uppercase tracking-wide">Study Streak</p>

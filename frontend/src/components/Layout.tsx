...
const NAV_LINKS = [
  ...
  { to: '/question-bank', icon: HelpCircle, label: 'Question Bank', exact: false },
        ...
        <div className="p-4 border-b border-border">
          <div className="flex items-center gap-2">
            <img
              ...
              onError={e => { (e.currentTarget as HTMLImageElement).src = '/assets/generated/app-icon-192.dim_192x192.png'; }}
            />
            <div>
              <h1 className="font-black text-sm text-foreground">Board Saathi</h1>
        ...
        <nav className="flex-1 overflow-y-auto p-3 space-y-0.5">
          {NAV_LINKS.map(({ to, icon: Icon, label, exact }) => (
            <Link
              ...
              activeProps={{ className: 'flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium bg-primary/10 text-primary' }}
              activeOptions={{ exact }}
            >

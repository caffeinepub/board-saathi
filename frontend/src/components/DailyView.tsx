...
import { Plus, Check, Trash2, Loader2, Clock } from 'lucide-react';
    ...
    <div className="space-y-4">
      ...
      {showForm && (
        <div className="border rounded-lg p-4 space-y-3 bg-muted/30">
          ...
          <div className="space-y-1">
            <Label htmlFor="task-time" className="text-xs">Start Time</Label>
            <Input
              id="task-time"
              type="time"
              value={startTime}
          ...
          <div className="flex gap-2">
            <Button size="sm" onClick={handleAdd} disabled={addTask.isPending} className="flex-1">
              {addTask.isPending ? <Loader2 className="w-3.5 h-3.5 animate-spin mr-1" /> : null}
              Save
            </Button>
              ...
              <div className="flex-1 min-w-0">
                ...
                {task.startTime && (
                  <div className="flex items-center gap-1 mt-1">
                    ...
                    <span className="text-xs text-muted-foreground">{task.startTime}</span>
                  </div>
                )}
              </div>
              <Button
